<template>
    <el-dialog title="修改电子签名密码" :visible.sync="visible" :append-to-body="true" width="400px">
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
            ...
            <el-form-item label="确认密码" prop="confirmPassword">
                <el-input type="password" v-model="dataForm.confirmPassword" maxlength="16"></el-input>
            </el-form-item>
        </el-form>
...
export default {
    ...
    methods: {
        ...
        async updatePass() {
            ...
            let result = await this.$get(this.$api.medical.signUpdatePassword, param)
