...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                ...
                {label: '产品编号', prop: 'productSn'},
                {label: '所属分类', prop: 'productCategoryName'},
                {label: '产品规格', prop: 'productModel'},
                {label: '品牌名称', prop: 'factoryName'},
    ...
    methods: {
        ...
        listCust() {
            ...
            param.keyword = this.productName

            this.$post(this.$api.activity.getAllProductList, param).then((data) => {
