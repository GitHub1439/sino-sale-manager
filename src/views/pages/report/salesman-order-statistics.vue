...
export default {
    ...
    data() {
        return {
            ...
            activeProtype: 'all',
            columns: [
                {label: '姓名', prop: 'name', width: 220},
                {label: '累积注册门店数', prop: 'customerTotal'},
                {label: '累积订单数', prop: 'orderTotal'},
                {label: '累积订单金额', prop: 'orderTotalAmount'},
                {label: '今日注册门店数', prop: 'customerNew'},
                {label: '今日订单数', prop: 'orderNew'},
                {label: '今日订单金额', prop: 'orderNewAmount'},
    ...
    methods: {
        ...
        getProductDatas() {
            ...
            this.$post(this.$api.report.salesman, params).then(res=>{
                if (res && res.code === 200) {
