...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                ...
                {label: '单体药房', prop: 'customerTypeCount1'},
                {label: '器械店', prop: 'customerTypeCount2'},
                {label: '器械批发', prop: 'customerTypeCount3'},
                {label: '连锁药房', prop: 'customerTypeCount4'},
                {label: '医药公司', prop: 'customerTypeCount5'},
                {label: '医疗机构', prop: 'customerTypeCount6'},
                {label: '连锁器械', prop: 'customerTypeCount7'},
                {label: '连锁无糖', prop: 'customerTypeCount8'},
                {label: '其它', prop: 'customerTypeCount9'},
            ], // 操作列
            loading: false,
            pageObj: {
                size: 10,
    ...
    methods: {
        ...
        getProductDatas() {
            ...
            this.$post(this.$api.report.customerType, params).then(res=>{
                if (res && res.code === 200) {
