...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                ...
                {label: '单体药房', prop: 'customerTypeOrderCount1'},
                {label: '器械店', prop: 'customerTypeOrderCount2'},
                {label: '器械批发', prop: 'customerTypeOrderCount3'},
                {label: '连锁药房', prop: 'customerTypeOrderCount4'},
                {label: '医药公司', prop: 'customerTypeOrderCount5'},
                {label: '医疗机构', prop: 'customerTypeOrderCount6'},
    ...
    methods: {
        ...
        getProductDatas() {
            ...
            this.$post(this.$api.report.customerTypeOrder, params).then(res=>{
                if (res && res.code === 200) {
