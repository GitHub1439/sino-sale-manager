        ...
        <div class="top-nav">
            <div class="tabs-card">
                <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                    <el-tab-pane label="经销商库" name="0"></el-tab-pane>
                </el-tabs>
            </div>
        </div>
                ...
                <div class="mini-switch-navorbtn">
                    <div class="tabs-card">
                        <el-tabs v-model="activeProtype" type="card" @tab-click="handleClickType">
                            <el-tab-pane label="所有经销商" name="all"></el-tab-pane>
                    ...
                    <div class="btnlist">
                        <input class="inputval-noborder" v-model="keyWord" @input="getProductDatas()" placeholder="请输入经销商名称或账号搜索"></input>
                        <button @click="addPro">
...
export default {
    ...
    data() {
        return {
            ...
            activeProtype: 'all',
            columns: [
                {label: '经销商名称', prop: 'orgName', width: 220},
